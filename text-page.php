		...
		<main class="main-content">
			<div class="container">
				<div class="page">
					...
					<h2>O nama</h2>
					<p>Planet Igara d.o.o. iz Zagreba je tvrtka koja se bavi maloprodajom igraćih konzola, dodatne
						opreme, igara (za konzole i PC), te cjelokupnog asortimana ponajprije vezanog za konzolaški
						gaming.

						Poslujemo od 1. rujna 2022. kao klasični dućan i webshop (internet trgovina) u Voltinama 44 u
						Zagrebu, dok od 1. lipnja 2023. poslujemo kao webshop samo u našem sjedištu na lokaciji Brune
						Bjelinskog 16 u Zagrebu.
						U slučaju da osobno dolazite kupiti/preuzeti robu u naše sjedište, potrebno je telefonski ili
						mailom se najaviti.</p>

					<h2>PODACI O TVRTKI:</h2>
					<p>Naziv: Planet IGARA d.o.o. za trgovinu i usluge
						<br>Sjedište: Zagreb, Brune Bjelinskog 16
						<br>Matični broj subjekta (MBS): 030562472, Trgovački sud u Zagrebu
						<br>Matični broj poslovnog subjekta prema NKD-u: 132452
						<br>OIB: 62926584145
						<br>IBAN (transakcijski račun) kod PBZ d.d.: HR5423489484823898925
						<br>Temeljni kapital: 20.000,00 kn uplaćen u cijelosti
						<br>Član uprave: Ivan Šimić
					</p>
					<ol>
						<li>Dio smo službene distributivne mreže <span style="color: #449fdb"><b>PlayStation®</b></span>
							i <span style="color: #d41b22"><b>Nintendo®</b></span> brandova u Republici Hrvatskoj!</li>
						<li>Planet Igara – Vaš #1 Gaming Webshop 🙂</li>
					</ol>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="feature">
								...
								<h3 class="feature-title">Sigurnost kupnje</h3>
								<p>U web shopu Planet Igara služimo se najsuvremenijim sigurnosnim tehnologijama koje
									omogućuju sigurno plaćanje internetom, te brinu o zaštiti privatnosti i
									povjerljivosti osobnih podataka.</p>
							</div> <!-- .feature -->
						</div> <!-- .column -->
						<div class="col-md-3">
							<div class="feature">
								...
								<h3 class="feature-title">Besplatna dostava</h3>
								<p>Kako bi omogućili čim jednostavnije narudžbe za sve naše kupce omogućili smo svim
									kupcima čije narudžbe prelaze 200 kn potpuno besplatnu dostavu neovisno o lokaciji
									na kojoj se nalazite.</p>
							</div> <!-- .feature -->
						</div> <!-- .column -->
						<div class="col-md-3">
							<div class="feature">
								...
								<p>Uz veliki broj usluga u ponudi imamo i uslugu dostave narudžbe na Vaš kućni prag. U
									nastavku provjerite najčešće upite i informacije vezane uz usluge dostave, te
									informacije o našim partnerima putem kojih vršimo uslugu dostave Vaših narudžbi.</p>
							</div> <!-- .feature -->
						</div> <!-- .column -->
						<div class="col-md-3">
							<div class="feature">
								...
								<h3 class="feature-title">24/h Pomoć</h3>
								<p>Za sve pritužbe, reklamacije i pohvale možete nam se obratiti i na e-mail adresu
									reklamacije@planet-igara.hr ili broj telefona 01/6821-555.</p>
							</div> <!-- .feature -->
						</div> <!-- .column -->
					</div> <!-- .row -->
				</div>
